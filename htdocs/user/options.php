...
class page_output
{
	...
	function execute()
	{
		...
		*/
		...
		$structure["defaultvalue"] = withdefault($options, "lang", '');
		$this->obj_form->add_input($structure);
		...
		$structure["defaultvalue"]	= withdefault($options, "dateformat", '');
		$this->obj_form->add_input($structure);
...
*/
		...
		$structure["defaultvalue"]	= withdefault($options, "shrink_tableoptions", '');
		...
		if (user_permissions_get("namedadmins"))
		{
			...
			$structure["type"]		= "checkbox";
			$structure["defaultvalue"]	= withdefault($options, "debug", '');
			...
			$structure["type"]		= "checkbox";
			$structure["defaultvalue"]	= withdefault($options, "concurrent_logins", '');
